...
export default function FloatingSocials() {
  ...
  return (
    <div className="floating-socials">
      <a href="https://www.instagram.com/zenova_consultants?igsh=MTgzeXU1OThvcnVlZA==" target="_blank" rel="noopener noreferrer" className="floating-link instagram" title="Instagram">
      ...
      <a href="https://www.facebook.com/share/1B4gYpAW5H/" target="_blank" rel="noopener noreferrer" className="floating-link facebook" title="Facebook">
      ...
      <a href="https://wa.me/919150484747" target="_blank" rel="noopener noreferrer" className="floating-link whatsapp" title="WhatsApp">
