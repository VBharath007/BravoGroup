...
export default function FloatingSocials() {
  ...
  return (
    <div className="floating-socials">
      <a href="https://www.instagram.com/zenova_consultants?igsh=MWF0cmFtOTVkZDQ0ZQ==" target="_blank" rel="noopener noreferrer" className="floating-link instagram" title="Instagram">
