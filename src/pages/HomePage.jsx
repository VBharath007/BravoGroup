...
export default function HomePage() {
      ...
      gsap.utils.toArray(".help-item").forEach((item) => {
        gsap.fromTo(item,
          { opacity: 0, x: 40 },
          {
            ...
            duration: 0.8,
            ease: "power2.out",
            force3D: true // ADD THIS LINE FOR GPU
          }
        );
      });
  ...
  return (
    <>
      ...
      {/* ── HERO SECTIONS ── */}
      {isMobile ? (
        <div className="mobile-hero-view" style={gpuStyle}>
          <HorizonHeroSection />
        </div>
      ) : (
        <div className="desktop-hero-view" style={gpuStyle}>
          <HorizonHeroSection />
        </div>
      )}

      {/* ── ABOUT bravogroup ── */}
      <section className="about-bravogroup" style={sectionGpuStyle}>
      ...
      <UniversitySection
        ...
        className="section-uzbekistan" style={sectionGpuStyle}
      />
      ...
      <UniversitySection
        ...
        unis={kyrgyzstanUnis}
        onUniClick={handleUniClick}
        className="section-kyrgyzstan" style={sectionGpuStyle}
      />
      ...
      <UniversitySection
        ...
        unis={georgiaUnis}
        onUniClick={handleUniClick}
        className="section-georgia" style={sectionGpuStyle}
      />
      ...
      <UniversitySection
        ...
        unis={russiaUnis}
        onUniClick={handleUniClick}
        className="section-russia" style={sectionGpuStyle}
      />
      ...
      <section className="home-gallery" style={sectionGpuStyle}>
      ...
      <section className="home-video-gallery" style={sectionGpuStyle}>
      ...
      <section className="section testimonials-premium" style={sectionGpuStyle}>
